    ...
    <div className="about-page-wp">
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
          <div className="font-sensei" style={{ fontSize: 'clamp(3rem, 6vw, 4.6rem)', color: 'var(--vamtam-accent-color-2)', lineHeight: 1, marginBottom: '6px' }}>
            Welcome
          </div>
          <h1 className="font-rounded" style={{ fontSize: 'clamp(2.2rem, 5vw, 3.6rem)', fontWeight: 900, color: 'var(--vamtam-accent-color-2)', marginBottom: '4px' }}>
            To Shomoukh Early Childhood
          </h1>
          <div className="font-rounded" style={{ fontSize: 'clamp(1.8rem, 4.2vw, 2.8rem)', fontWeight: 900, color: 'var(--vamtam-accent-color-2)' }}>
            Education Center
          </div>
        </div>
      ...
      <section style={{ padding: '90px 0', background: '#FFFFFF' }}>
        <div className="container">
          <div style={{
            ...
            <div className="modern-card" style={{ background: '#FAF7F2', padding: '40px', border: '1px solid rgba(231, 76, 37, 0.1)' }}>
              <div style={{
              ...
              <h2 className="font-rounded" style={{ fontSize: '2rem', fontWeight: 900, color: 'var(--vamtam-accent-color-2)', marginBottom: '16px' }}>
                Nurturing Wonder & Potential
              </h2>
              ...
              <p style={{ color: 'var(--text-main)', fontSize: '1.05rem', lineHeight: 1.7, marginBottom: '32px' }}>
            ...
            {/* 4-Image Collage Grid with Zoom effect */}
            <div style={{
              display: 'grid',
              gridTemplateColumns: '1fr 1fr',
              gap: '18px'
            }}>
              <div className="modern-card" style={{ height: '190px', overflow: 'hidden' }}>
      ...
      <section style={{ padding: '80px 0', background: '#FAF7F2' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <div className="modern-card" style={{ padding: '40px', background: '#FFFFFF', maxWidth: '960px', margin: '0 auto' }}>
            <img 
          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{
                ...
                <img src="/assets/Community-image.jpg" alt="Philosophy video cover" style={{ width: '100%', height: '260px', objectFit: 'cover' }} />
              </div>
      ...
      <section style={{ padding: '90px 0', background: '#FAF7F2' }}>
        <div className="container">
          <div style={{
            ...
            <div>
              <div className="modern-card" style={{ padding: '32px', marginBottom: '24px', background: '#FFFFFF' }}>
                <h3 className="font-rounded" style={{ fontSize: '1.6rem', fontWeight: 800, color: 'var(--vamtam-accent-color-2)', marginBottom: '10px' }}>
                  EXPECTATION
                </h3>
              ...
              <div className="modern-card" style={{ padding: '32px', marginBottom: '32px', background: '#FFFFFF' }}>
                <h3 className="font-rounded" style={{ fontSize: '1.6rem', fontWeight: 800, color: 'var(--vamtam-accent-color-2)', marginBottom: '10px' }}>
                  Community
                </h3>
                <p style={{ color: 'var(--text-muted)', fontSize: '1rem', lineHeight: 1.7 }}>
            ...
            <div className="modern-card" style={{ overflow: 'hidden', height: '420px' }}>
              <img src="/assets/h-02-1.jpg" alt="Community" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <div className="modern-card" style={{ overflow: 'hidden', height: '320px' }}>
              <img src="/assets/h-09.jpg" alt="Giving Back" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
            <div>
              <h3 className="font-rounded" style={{ fontSize: '2.2rem', fontWeight: 900, color: 'var(--vamtam-accent-color-2)', marginBottom: '16px' }}>
                Giving Back
              </h3>
          ...
          <div className="modern-card" style={{
            ...
            padding: '48px',
            marginBottom: '70px',
            borderLeft: '6px solid var(--vamtam-accent-color-1)'
          }}>
            <h3 className="font-rounded" style={{ fontSize: '2.2rem', fontWeight: 900, color: 'var(--vamtam-accent-color-2)', marginBottom: '16px' }}>
              Environment
            </h3>
          ...
          <div style={{
            ...
            <div>
              ...
              <button 
                ...
                className="wp-btn wp-btn-primary"
              >
                <span>Read Full Policies</span>
                <ArrowRight size={16} />
              </button>
            </div>
            <div className="modern-card" style={{ overflow: 'hidden', height: '320px' }}>
              <img src="/assets/h-07.jpg" alt="Health and Safety" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            </div>
          </div>
