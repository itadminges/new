...
import { Drama, Lightbulb, Music, Palette, Puzzle, Volleyball } from 'lucide-react';
      ...
      <section style={{ padding: '90px 0', background: '#FFFFFF' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '820px', margin: '0 auto 60px' }}>
            <h2 className="font-rounded" style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--vamtam-accent-color-2)', marginBottom: '18px' }}>
              Shomoukh Ateliers
            </h2>
          ...
          <div style={{
            ...
            {/* Clay Atelier */}
            <div style={{ background: '#FAF7F2', borderRadius: '24px', overflow: 'hidden', textAlign: 'center', boxShadow: '0 8px 24px rgba(0,0,0,0.04)' }}>
      ...
      <section style={{ padding: '90px 0', background: '#FAF7F2' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            <h2 className="font-rounded" style={{ fontSize: '2.5rem', fontWeight: 800, color: 'var(--vamtam-accent-color-2)', letterSpacing: '0.04em' }}>
              OUR ACTIVITIES
            </h2>
          </div>
          ...
          <div style={{
            ...
            {activities.map((act, idx) => {
              ...
              >
                ...
                <div>
                  <h3 className="font-rounded" style={{ fontSize: '1.25rem', fontWeight: 800, color: 'var(--vamtam-accent-color-2)', marginBottom: '8px' }}>
                    {act.title}
                  </h3>
                  <p style={{ fontSize: '0.92rem', color: 'var(--text-muted)', lineHeight: 1.6 }}>
                    {act.desc}
